...
<body>
    ...
    <div class="container-1">
        ...
        <div class="box-2">
            <h3>We could't find the Series you wanted to watch!</h3>
            <p style="margin-top: 100px;">Series Description:<br>Error: Can't find the Description for this Series!</p>
            <p style="margin-top: 100px;">Episode:<br></p>
            <p>Ep:1</p>
            <p>Ep:2</p>
            <p>Ep:3</p>
            <p>Ep:4</p>
